...
**IMPORTANTE:** Esta skill requer interação do usuário para inserir credenciais (CNPJ e senha). O Codex NÃO deve inserir credenciais bancárias.
...
Codex: Vou ajudá-lo a baixar o extrato OFX do Sicredi do mês anterior.
...
Codex: 3. Navegando para a página de Extrato...
