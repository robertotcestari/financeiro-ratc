                      ...
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          <div className="flex items-center space-x-2 mb-2">
                            {getMatchStatusIcon(transaction.matched)}
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            {(transaction.currentCategoryName || transaction.currentPropertyCode) && (
                              <div className="text-xs text-muted-foreground">
                                {transaction.currentCategoryName && (
                                  <span>Categoria atual: {transaction.currentCategoryName}</span>
                                )}
                                {transaction.currentPropertyCode && (
                                  <span className="ml-2">
                                    Propriedade: {transaction.currentPropertyCode}
                                  </span>
                                )}
                              </div>
                            )}
