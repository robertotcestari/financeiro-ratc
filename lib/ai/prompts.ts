...
4. Transações de aluguel, condomínio e IPTU DEVEM OBRIGATORIAMENTE ter uma propriedade associada
...
- Manutenções e reparos: categoria "Manutenção" + propriedade quando identificável
