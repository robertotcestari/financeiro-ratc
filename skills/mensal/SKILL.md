---
name: Mensal
description: DEPRECATED. Use `relatorio-mensal` instead. Monthly workflow for importing OFX bank files and categorizing transactions.
---
...
This skill has been replaced by `relatorio-mensal`.
Use `relatorio-mensal` for the current end-to-end monthly workflow.
